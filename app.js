...
const slides = [
  ...
  },
  {
    ...
    subtitle: "高校、顾问/导师和学员的使用场景不同，但都需要把“专业能做什么”讲清楚、讲具体、讲可行动。",
    duration: "约 45 秒",
    layout: "users",
    corePain: {
      title: "学员核心痛点",
    ...
    audiences: [
      ...
      ["顾问 / 导师", ["求职导师", "企业导师", "升学与就业顾问"], ["快速完成专业就业分析", "用数据支撑规划建议", "提升咨询交付标准化"]],
      ["学员", ["在校生", "应届毕业生", "留学生", "转专业或求职方向探索者"], ["理解本专业就业方向", "判断目标城市和行业", "识别岗位能力要求并制定行动计划"]]
    ],
    signals: ["高校需要专业就业趋势内容", "顾问/导师需要稳定的数据依据", "学员持续提出“XX 专业能做什么”的具体咨询"],
